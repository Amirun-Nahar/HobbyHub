...
const CreateGroup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Sending group data:', { ...groupData, imageURL: 'TRUNCATED' });
      ...
      const errorMessage = error.response?.data?.message || error.message || 'Error creating group';
      ...
      <Fade>
        <div className="relative max-w-4xl mx-auto">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url("https://media.overstockart.com/cache/data/preframed_aotd/VG2751-FR-530320X24-1000x1000.jpg")',
              filter: 'brightness(1)',
            }}
          >
          ...
          {/* Form Content */}
          <div className="relative bg-white bg-opacity-85 dark:bg-gray-800 dark:bg-opacity-85 p-8 md:p-10 rounded-2xl shadow-2xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Create a New Group</h2>
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                Start your journey by creating a new hobby group
              </p>
            </div>
